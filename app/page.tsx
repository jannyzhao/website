...
export default function Home() {
  return (
    <div className="flex justify-center items-center p-4 md:p-16 lg:pt-24">
      <div className="flex flex-col items-center md:flex-row justify-center gap-16 max-w-xl">
        <div>
        ...
        <div className="gap-4 text-center">
          ...
          <div className="flex flex-row justify-center items-center gap-5 pt-2">
            <a href="https://www.linkedin.com/in/jannyzhao/" target="_blank">
              <svg
            ...
            <a href="https://github.com/jannyzhao" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-7 w-7"
                fill="currentColor"
            ...
            <a href="https://twitter.com/janszhao" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-7 w-7"
                fill="currentColor"
            ...
            <a href="mailto:zhao.janny@gmail.com">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
